...
export class MissionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.missionService
      ...
      .subscribe(
        (res: HttpResponse<IMission[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMissions(): void {
    this.eventSubscriber = this.eventManager.subscribe('missionListModification', () => this.loadPage());
  }
