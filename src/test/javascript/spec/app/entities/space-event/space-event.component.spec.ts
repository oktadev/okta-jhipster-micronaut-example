...
import { SpaceEventComponent } from 'app/entities/space-event/space-event.component';
...
describe('Component Tests', () => {
  describe('SpaceEvent Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.spaceEvents && comp.spaceEvents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
