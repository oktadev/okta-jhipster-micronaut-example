...
🚀 Find the code on GitHub: https://github.com/oktadeveloper/okta-jhipster-micronaut-example[@oktadeveloper/okta-jhipster-micronaut-example].

👀 Read the blog post: https://developer.okta.com/blog/2020/08/17/micronaut-jhipster-heroku[Build a Secure Micronaut and Angular App with JHipster].
